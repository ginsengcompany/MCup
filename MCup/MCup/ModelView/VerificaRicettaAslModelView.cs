...
{
    public class VerificaRicettaAslModelView : INotifyPropertyChanged
    {
        ...
        private VerificaRicettaAsl verifica; //oggetto di tipo Verificaricetta che utilizziamo per richiamare i metodi nella pagina a cui si riferisce il modelview
        ...
        private List<string> listaMedici = new List<string>();
        ...
        public List<string> ListaMedici
        {
            ...
            set
            {
                listaMedici = new List<string>(value);
                OnPropertyChanged();
            }
        }
        ...
        //Costruttore
        public VerificaRicettaAslModelView(Impegnativa impegnativa, VerificaRicettaAsl verifica, Assistito contatto)
        {
            IsEnabled = true;
        ...
        private async void RicezioneMedici()
        {
            REST<object,string> connRest = new REST<object, string>();
            ListaMedici = await connRest.GetListJson(SingletonURL.Instance.getRotte().listaMediciCombo,headers);
        }

        public Func<string, ICollection<string>, ICollection<string>> SortMedici { get; } = (text, values) => values
